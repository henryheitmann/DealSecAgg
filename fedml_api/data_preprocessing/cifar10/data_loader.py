...
def dummy_load_partition_data_cifar10(dataset, data_dir, partition_method, partition_alpha, client_number, batch_size):
    X_train, y_train, X_test, y_test, net_dataidx_map, traindata_cls_counts = partition_data(dataset,
                                                                                             data_dir,
                                                                                             partition_method,
                                                                                             client_number,
    ...
    for client_idx in range(client_number):
        data_local_num_dict[client_idx] = client_idx
        train_data_local_dict[client_idx] = client_idx
        test_data_local_dict[client_idx] = client_idx
